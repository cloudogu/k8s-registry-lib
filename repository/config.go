...
func (cr configRepository) create(ctx context.Context, name configName, doguName cescommon.SimpleDoguName, cfg config.Config) (config.Config, error) {
...
func (cr configRepository) update(ctx context.Context, name configName, doguName cescommon.SimpleDoguName, cfg config.Config) (config.Config, error) {
	var buf bytes.Buffer
