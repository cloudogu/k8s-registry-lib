...
func (dcr DoguConfigRepository) Get(ctx context.Context, name cescommon.SimpleDoguName) (config.DoguConfig, error) {
...
func (dcr DoguConfigRepository) Delete(ctx context.Context, name cescommon.SimpleDoguName) error {
...
func (dcr DoguConfigRepository) Watch(ctx context.Context, dName cescommon.SimpleDoguName, filters ...config.WatchFilter) (<-chan DoguConfigWatchResult, error) {
