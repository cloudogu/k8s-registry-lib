...
func TestGlobalConfigRepository_Create(t *testing.T) {
	t.Run("Create Global Config", func(t *testing.T) {
		mConfigRepo := newMockGeneralConfigRepository(t)
		mConfigRepo.EXPECT().create(mock.Anything, createConfigName(_SimpleGlobalConfigName), dogu.SimpleName(""), mock.Anything).Return(config.Config{PersistenceContext: resourceVersion}, nil)
	...
	t.Run("Config repo error", func(t *testing.T) {
		mConfigRepo := newMockGeneralConfigRepository(t)
		mConfigRepo.EXPECT().create(mock.Anything, createConfigName(_SimpleGlobalConfigName), dogu.SimpleName(""), mock.Anything).Return(config.Config{}, assert.AnError)
...
func TestGlobalConfigRepository_Update(t *testing.T) {
	t.Run("Update Global Config", func(t *testing.T) {
		mConfigRepo := newMockGeneralConfigRepository(t)
		mConfigRepo.EXPECT().update(mock.Anything, createConfigName(_SimpleGlobalConfigName), dogu.SimpleName(""), mock.Anything).Return(config.Config{PersistenceContext: resourceVersion}, nil)
	...
	t.Run("Config repo error", func(t *testing.T) {
		mConfigRepo := newMockGeneralConfigRepository(t)
		mConfigRepo.EXPECT().update(mock.Anything, createConfigName(_SimpleGlobalConfigName), dogu.SimpleName(""), mock.Anything).Return(config.Config{}, assert.AnError)
