...
func (_m *mockConfigClient) Create(ctx context.Context, name string, doguName string, dataStr string) (resourceMetaAccessor, error) {
	...
	var r0 resourceMetaAccessor
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, string, string, string) (resourceMetaAccessor, error)); ok {
		return rf(ctx, name, doguName, dataStr)
	}
	if rf, ok := ret.Get(0).(func(context.Context, string, string, string) resourceMetaAccessor); ok {
		r0 = rf(ctx, name, doguName, dataStr)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(resourceMetaAccessor)
		}
	}
...
func (_c *mockConfigClient_Create_Call) Return(_a0 resourceMetaAccessor, _a1 error) *mockConfigClient_Create_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *mockConfigClient_Create_Call) RunAndReturn(run func(context.Context, string, string, string) (resourceMetaAccessor, error)) *mockConfigClient_Create_Call {
	_c.Call.Return(run)
	return _c
}
...
// SetOwnerReference provides a mock function with given fields: ctx, cmName, owner
func (_m *mockConfigClient) SetOwnerReference(ctx context.Context, cmName string, owner []v1.OwnerReference) (resourceMetaAccessor, error) {
	ret := _m.Called(ctx, cmName, owner)
	...
	var r0 resourceMetaAccessor
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, string, []v1.OwnerReference) (resourceMetaAccessor, error)); ok {
		return rf(ctx, cmName, owner)
	}
	if rf, ok := ret.Get(0).(func(context.Context, string, []v1.OwnerReference) resourceMetaAccessor); ok {
		r0 = rf(ctx, cmName, owner)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(resourceMetaAccessor)
		}
	...
	if rf, ok := ret.Get(1).(func(context.Context, string, []v1.OwnerReference) error); ok {
		r1 = rf(ctx, cmName, owner)
	} else {
		r1 = ret.Error(1)
	}
...
// mockConfigClient_SetOwnerReference_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'SetOwnerReference'
type mockConfigClient_SetOwnerReference_Call struct {
	*mock.Call
}
...
func (_e *mockConfigClient_Expecter) SetOwnerReference(ctx interface{}, cmName interface{}, owner interface{}) *mockConfigClient_SetOwnerReference_Call {
	return &mockConfigClient_SetOwnerReference_Call{Call: _e.mock.On("SetOwnerReference", ctx, cmName, owner)}
}

func (_c *mockConfigClient_SetOwnerReference_Call) Run(run func(ctx context.Context, cmName string, owner []v1.OwnerReference)) *mockConfigClient_SetOwnerReference_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *mockConfigClient_SetOwnerReference_Call) Return(_a0 resourceMetaAccessor, _a1 error) *mockConfigClient_SetOwnerReference_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *mockConfigClient_SetOwnerReference_Call) RunAndReturn(run func(context.Context, string, []v1.OwnerReference) (resourceMetaAccessor, error)) *mockConfigClient_SetOwnerReference_Call {
	_c.Call.Return(run)
	return _c
}

// Update provides a mock function with given fields: ctx, pCtx, name, doguName, dataStr
func (_m *mockConfigClient) Update(ctx context.Context, pCtx string, name string, doguName string, dataStr string) (resourceMetaAccessor, error) {
	...
	var r0 resourceMetaAccessor
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, string, string, string, string) (resourceMetaAccessor, error)); ok {
		return rf(ctx, pCtx, name, doguName, dataStr)
	}
	if rf, ok := ret.Get(0).(func(context.Context, string, string, string, string) resourceMetaAccessor); ok {
...
func (_c *mockConfigClient_Update_Call) Return(_a0 resourceMetaAccessor, _a1 error) *mockConfigClient_Update_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *mockConfigClient_Update_Call) RunAndReturn(run func(context.Context, string, string, string, string) (resourceMetaAccessor, error)) *mockConfigClient_Update_Call {
	_c.Call.Return(run)
	return _c
}

// UpdateClientData provides a mock function with given fields: ctx, update
func (_m *mockConfigClient) UpdateClientData(ctx context.Context, update clientData) (resourceMetaAccessor, error) {
	...
	var r0 resourceMetaAccessor
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, clientData) (resourceMetaAccessor, error)); ok {
		return rf(ctx, update)
	}
	if rf, ok := ret.Get(0).(func(context.Context, clientData) resourceMetaAccessor); ok {
		r0 = rf(ctx, update)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(resourceMetaAccessor)
...
func (_c *mockConfigClient_UpdateClientData_Call) Return(_a0 resourceMetaAccessor, _a1 error) *mockConfigClient_UpdateClientData_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *mockConfigClient_UpdateClientData_Call) RunAndReturn(run func(context.Context, clientData) (resourceMetaAccessor, error)) *mockConfigClient_UpdateClientData_Call {
	_c.Call.Return(run)
	return _c
}
