...
// setOwnerReference provides a mock function with given fields: ctx, name, owners
func (_m *mockGeneralConfigRepository) setOwnerReference(ctx context.Context, name configName, owners []v1.OwnerReference) error {
	ret := _m.Called(ctx, name, owners)
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, configName, []v1.OwnerReference) error); ok {
		r0 = rf(ctx, name, owners)
	} else {
		r0 = ret.Error(0)
	}
...
// mockGeneralConfigRepository_setOwnerReference_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'setOwnerReference'
type mockGeneralConfigRepository_setOwnerReference_Call struct {
	*mock.Call
}
...
func (_e *mockGeneralConfigRepository_Expecter) setOwnerReference(ctx interface{}, name interface{}, owners interface{}) *mockGeneralConfigRepository_setOwnerReference_Call {
	return &mockGeneralConfigRepository_setOwnerReference_Call{Call: _e.mock.On("setOwnerReference", ctx, name, owners)}
}

func (_c *mockGeneralConfigRepository_setOwnerReference_Call) Run(run func(ctx context.Context, name configName, owners []v1.OwnerReference)) *mockGeneralConfigRepository_setOwnerReference_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(configName), args[2].([]v1.OwnerReference))
	})
	return _c
}

func (_c *mockGeneralConfigRepository_setOwnerReference_Call) Return(_a0 error) *mockGeneralConfigRepository_setOwnerReference_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *mockGeneralConfigRepository_setOwnerReference_Call) RunAndReturn(run func(context.Context, configName, []v1.OwnerReference) error) *mockGeneralConfigRepository_setOwnerReference_Call {
	_c.Call.Return(run)
	return _c
}
